-- Migration 001: Schema Inicial do Sistema GEBV
-- Criação de tabelas base de associados, histórico bruto e auditoria
...
-- 2. Histórico Bruto de Progressões (JSON do Paxtu / Backup)
...
-- 3. Atividades Legadas (mantida por compatibilidade temporária)
