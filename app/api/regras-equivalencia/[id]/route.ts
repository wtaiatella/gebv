...
export async function PUT(request: Request, { params }: Params) {
  try {
    ...
    if (descricao_origem !== undefined) dataToUpdate.descricao_origem = descricao_origem;
    if (origem_pistas_ueb !== undefined) dataToUpdate.origem_pistas_ueb = Array.isArray(origem_pistas_ueb) ? origem_pistas_ueb : [];
    if (origem_rumo_ueb !== undefined) dataToUpdate.origem_rumo_ueb = Array.isArray(origem_rumo_ueb) ? origem_rumo_ueb : [];
    if (origem_especialidades !== undefined) dataToUpdate.origem_especialidades = Array.isArray(origem_especialidades) ? origem_especialidades : [];
    if (nivel_min_especialidade !== undefined) dataToUpdate.nivel_min_especialidade = parseInt(nivel_min_especialidade, 10);
    if (min_count !== undefined) dataToUpdate.min_count = parseInt(min_count, 10);
